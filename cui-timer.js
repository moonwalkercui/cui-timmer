...
(function($) {
	...
	Cuitimer.prototype = {
		...
		getYMDHIS: function(endtime) {
			...
			var dayStr = (remain.d == '00') ? "" : "<span class='cui-day'>" + _this.addZero(remain.d) + "天</span> ";
			return " " + dayStr + "<span class='cui-time'>" + _this.addZero(remain.h) + ":" + _this.addZero(remain.i) + ":" +
				_this.addZero(remain.s) + "</span>";
		},
			...
			window.setInterval(function() {
				...
				if (_msec && hasTime) {
					...
					var setid = window.setInterval(function() {
						_ele.html(timeStr + "<span class='cui-msec'>." + loop + "</span>");
						if (loop > 0) loop--;
